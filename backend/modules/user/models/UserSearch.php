...
namespace gromver\platform\backend\modules\user\models;
...
/**
 * Class UserSearch represents the model behind the search form about `gromver\platform\common\models\User`.
 * @package yii2-cmf
