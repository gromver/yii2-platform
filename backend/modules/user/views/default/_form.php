...
<div class="user-form">
    ...
    <?= $form->field($model, 'status')->dropDownList(\gromver\platform\common\models\User::statusLabels()) ?>
    ...
    <div>
        ...
        <?php if (!$model->isNewRecord) {
            echo Html::a(Yii::t('gromver.platform', 'Params'), ['params', 'id' => $model->id], ['class' => 'btn btn-default']);
        } ?>
    </div>
