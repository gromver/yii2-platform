...
class m140811_143606_cms_create_tables extends Migration
{
    public function up()
    {
        ...
        $this->createTable('{{%cms_category}}', [
                ...
                'subscribe_id' => Schema::TYPE_INTEGER . ' DEFAULT NULL',
        ...
        $this->createIndex('ParentId_idx', '{{%cms_menu}}', 'parent_id');
        $this->createIndex('Lft_Rgt_idx', '{{%cms_menu}}', 'lft, rgt');
        $this->createIndex('Language_idx', '{{%cms_menu}}', 'language');
        $this->createIndex('Path_idx', '{{%cms_menu}}', 'path');
        $this->createIndex('Alias_idx', '{{%cms_menu}}', 'alias');
        $this->createIndex('Status_idx', '{{%cms_menu}}', 'status');
